...
# IMPORTANT: Vercel FastAPI entrypoint
...
<div class="overlay">
    ...
    <p>Data Engine: <span class="highlight">Connected</span></p>
    ...
    <p style="margin-top:25px;font-size:0.8em;color:#777;">
...
@app.get("/FetchData")
def fetch_data(Number: str = Query(default=None)):
